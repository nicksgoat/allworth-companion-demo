...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 15, color: "rgba(255,255,255,0.6)", marginTop: 10 },
  ...
  coreTitle: { fontSize: 15, fontWeight: "600", color: "#fff", textAlign: "center" },
  nightly: { flexDirection: "row", alignItems: "center", gap: 4 },
  nightlyText: { fontSize: 11, color: "rgba(255,255,255,0.55)" },
  loopNode: {
    position: "absolute",
    width: 34,
    height: 34,
  ...
  calloutMarkerText: { fontSize: 13, fontWeight: "700", color: colors.allworthNavy },
  calloutTitle: { fontSize: 15, fontWeight: "600", color: "#fff" },
  calloutDetail: { fontSize: 13, color: "rgba(255,255,255,0.65)" },
  closing: {
    fontSize: 19,
    fontWeight: "600",
    fontStyle: "italic",
