...
const SECTIONS: HubSection[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        title: 'Jarvis Encyclopedia',
        tag: 'live',
        color: 'navy',
        href: '/jarvis',
        host: '/jarvis',
        desc: 'Search the Allworth operating encyclopedia for shared definitions, processes, ownership, and institutional knowledge.',
        icon: svg(<><path d="M5 4h12a2 2 0 0 1 2 2v14H7a2 2 0 0 1-2-2z" /><path d="M9 8h6" /><path d="M9 12h6" /><path d="M9 16h4" /></>),
      },
      {
        id: 'nfbc',
        toolId: 'nfbc',
      ...
      },
      {
        ...
        href: '/crm',
        host: '/crm',
        desc: 'Client 360 for searching the book, reviewing activity and opportunities, and moving between a household and its advisor relationship.',
      ...
      },
      {
        ...
        href: '/planning',
        host: '/planning',
        desc: 'Build households and scenarios, project cash flow and net worth, and run retirement, tax, estate, goal, and Monte Carlo analysis.',
      ...
      },
      {
        ...
        href: '/avantos',
        host: '/avantos',
        desc: 'Rank planning households by plan health, actuals drift, publication state, alerts, and open advisor work.',
        icon: svg(<><path d="M3 17l6-6 4 4 8-8" /><path d="M14 7h7v7" /></>),
      },
      {
        id: 'rebalancer',
        toolId: 'rebalancer',
        kicker: 'Tax transition',
        title: 'Mock Rebalancer',
        tag: 'new',
        color: 'teal',
        href: '/rebalancer',
        host: '/rebalancer',
        desc: 'Model lot-level portfolio transitions against a target allocation with tax budgets, restrictions, and wash-sale rules.',
        icon: svg(<><path d="M12 3v18" /><path d="M5 8l7-5 7 5" /><path d="M3 14a3 3 0 0 0 6 0l-3-6z" /><path d="M15 14a3 3 0 0 0 6 0l-3-6z" /></>),
      },
      {
        id: 'sfp2',
        toolId: 'sfp2',
      ...
      },
      {
        ...
        href: '/bond-analyzer',
        host: '/bond-analyzer',
        desc: 'Analyze bond ladders and account holdings, review called bonds, and build fixed-income portfolio proposals.',
      ...
      },
      {
        ...
        href: '/advisor-mailer',
        host: '/advisor-mailer',
        desc: 'Upload an account workbook, preview one tailored message per advisor, and deliberately send the approved batch through Microsoft Graph.',
...
const cardSummary: Record<string, string> = {
  ...
  jarvis: 'Find trusted definitions, operating context, and ownership.',
  ...
  avantos: 'Prioritize households by plan health, drift, and open work.',
  rebalancer: 'Model tax-aware portfolio transitions before execution.',
...
export default function Home() {
  ...
  const widgetAccess = {
    ...
    avantos: canAccessTool(access, 'avantos'),
  };
