...
ROUTING_CASES = [
    ...
    ("Run my retirement projection", "monday", "Monte Carlo retirement projection"),
    ("Is my portfolio drifting from target?", "monday", "full drift analysis"),
    ("Am I on track for the lake house?", "monday", "funding analysis across all three"),
